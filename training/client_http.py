...
class Client(object):
	...
	def env_create(self, difficulty,visualize):
		route ='/v1/envs/'
		data = {'difficulty':difficulty,'visualize':visualize}
	...
	def env_reset(self, instance_id,difficulty):
...
if __name__ == '__main__':
    remote_base = 'http://210.107.234.154:5000'
    client = Client(remote_base)

    # Create environment
    difficulty = 0
    instance_id = client.env_create(difficulty)
