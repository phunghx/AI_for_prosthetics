...
from rpm_order import rpm # replay memory implementation
...
class nnagent(object):
    ...
    def train_step_gen(self):
        ...
        opt_critic = tf.train.AdamOptimizer(1e-5)
    ...
    def play(self,env,max_steps=-1,realtime=False,noise_level=0.): # play 1 episode
        ...
        if self.training == True:
          ...
          with open('./logs/result.txt','a') as f:
             f.write(str(steps)+ ','+str(total_reward)+ '\n')
    ...
    def save_weights(self, episode):
        ...
        for name in networks:
            ...
            network.save_weights('./model2/ddpg_'+name+str(episode) +'.npz')
